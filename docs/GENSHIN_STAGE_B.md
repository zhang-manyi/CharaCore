...
2026-09-22 后续：v0.3 协议复核、36对待人工复核刺激和盲标流程见 [GENSHIN_STAGE_B_CALIBRATION.md](GENSHIN_STAGE_B_CALIBRATION.md)。下文仅保留v0.2历史状态、评分语义与复现方式，不作为当前待办；项目范围以 [DESIGN.md](DESIGN.md) 为准。两版均未完成实际裁判校准或正式冻结。
